...
const domManipulator = (() => {
    ...
    function renderTodayTasks() {
        ...
        todoDisplay.innerHTML = `<h2>To-do for today, ${((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(), "do MMM yyyy, EEE"))}:</h2>`
